                                                ...
                                                <table>
                                                        <thead>
                                                                ...
                                                                <tr class="row100 head">
                                                                        ...
                                                                        <th class="cell100 column4">MemberID</th>
                                                                        <th class="cell100 column4">MembName</th>
                                                                        <th class="cell100 column4">MembNo</th>
                                                                        <th class="cell100 column4">MembAdd</th>
                                                                        <th class="cell100 column4">MembUsr</th>
                                                ...
                                                <table>
                                                        <tbody>
                                                                <tr class="row100 body">
                                                                        ...
                                                                        <td class="cell100 column4"><?php echo"$mno";?></td>
                                                                        <td class="cell100 column4"><?php echo"$madd";?></td>
                                                                        <td class="cell100 column4"><?php echo"$muser";?></td>
                                                                        <td class="cell100 column4"><?php echo"$tid";?></td>
                                                                </tr>
                                                        </tbody>
                                                </table>
                        </div>
